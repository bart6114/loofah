...
vi.mock("~/types/tauri.gen", () => ({
  commands: { enhancedDocGet: mocks.enhancedDocGet },
}));
...
it("waits for saved tasks before exposing generated Markdown to an editor", async () => {
  ...
  renderHook(() => useEnhancedNote("summary", undefined, "session"));
