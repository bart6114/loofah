...
The corrected Apple Silicon DMG is available in [workflow 35210702489](https://github.com/bart6114/loofah/actions/runs/35210702489/artifacts/10493891139), built from product commit `446a8c0ddc85ac7ae8992be479a05f146bdc9012`. It includes all product fixes above; the subsequent `5d52f11c8` commit changes only test isolation and this status note. The artifact expires on 1 October 2026.

- Local DMG: `/Users/bart/Downloads/Loofah-Sync-Staging-446a8c0dd/Loofah Staging_0.38.0_aarch64.dmg`.
- Installed app: `/Applications/Loofah Staging.app`, identifier `io.loofah.staging`. Normal Loofah remains installed separately. The QA app was quit after disconnecting the disposable account.
- SHA-256: `0c33eb84fe0b7d8cd392e98089ecabc883102d4bd286077d24d08d30cbb801bc`.
...
This remains a draft staging milestone until the outstanding acceptance checks pass. Bart’s private invitation link was supplied in the conversation and expires on 24 September; it is not stored in git.
...
2. Open the private invitation, register `bartsmeets86@gmail.com`, verify the email and sign in. Complete password entry and email verification in the browser. Verification resend and password reset should be tested through the browser; password reset does not restore encryption keys.
