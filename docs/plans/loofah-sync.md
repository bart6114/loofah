...
- [ ] Invitations reject missing, mismatched, expired, revoked and replayed tokens.
- [ ] Concurrent signup cannot reuse invitations or exceed capacity.
...
- Migrations 0008 and 0009 are applied to staging. Current staging Worker version: `c6320ab9-6dd1-40d9-a610-ad79e6d0028d`. The runtime regression test exercises the actual Hono WebSocket upgrade; ordinary security headers remain enabled on HTTP routes.
