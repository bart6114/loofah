...
export type OverlayState = { type: "floatingBar"; state: FloatingBarState } | { type: "transcript"; state: FloatingBarState } | { type: "liveCaption"; state: LiveCaptionState } | { type: "devtools" }
